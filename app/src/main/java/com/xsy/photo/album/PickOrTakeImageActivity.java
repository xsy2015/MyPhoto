...
import com.xsy.photo.utils.CommonUtil;
import com.xsy.photo.utils.LoaderNativeImage;
import com.xsy.photo.utils.MyConstants;
...
//        window.setBackgroundDrawable(getResources().getDrawable(R.color.white));
    ...
    protected void initData() {
        ...
        //计算每张图片应该显示的宽度
        perWidth = (((WindowManager) (MyApplication.getInstance().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getWidth() - CommonUtil.dip2px(this, 4)) / 3;
...
//                intent.putExtra(PickBigImagesActivity.EXTRA_DATA, getChoosePicFromList());
                PhotoUtils.allimages = getChoosePicFromList();
        ...
        public void onClick(View view) {
            ...
            if (i == R.id.iv_content) {
                ...
                if (picNums > 1) {
                    Intent intent = new Intent();
                    intent.setClass(PickOrTakeImageActivity.this, PickBigImagesActivity.class);
                    PhotoUtils.allimages =getAllImagesFromCurrentDirectory();
